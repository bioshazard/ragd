...
- Config: environment-driven (`DATABASE_URL`, `OPENAI_BASE_URL`, `EMBED_MODEL_DEFAULT`, chunking/search knobs); prefer sane defaults but fail fast when required env is missing.
